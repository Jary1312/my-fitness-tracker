...
function ExerciseDetail({ ex, onChange, onDelete, onBack, units, t }) {
  ...
  return (
    <div style={{padding:"0 16px"}} {...swipe}>
      <button onClick={onBack} style={{background:"none",border:"none",color:"#FF6B35",fontSize:14,cursor:"pointer",display:"flex",alignItems:"center",gap:4,padding:"20px 8px 12px 0",fontFamily:"inherit"}}>← {t.back}</button>
...
function MeasurementDetail({ meas, onChange, onDelete, onBack, units, t }) {
  ...
  return (
    <div style={{padding:"0 16px"}} {...swipe}>
      <button onClick={onBack} style={{background:"none",border:"none",color:"#00D4AA",fontSize:14,cursor:"pointer",display:"flex",alignItems:"center",gap:4,padding:"20px 8px 12px 0",fontFamily:"inherit"}}>← {t.back}</button>
      <ProgressStat entries={entries} period={period} totalProgress={totalProgress} t={t} accentColor="#00D4AA"/>
      <div style={{background:"#111120",border:"1px solid #1e1e30",borderRadius:20,padding:"18px 10px 10px",marginBottom:14}}>
...
function ExercisesView({ folder, onUpdate, onBack, units, t }) {
  ...
  return (
    <div>
      <div style={{padding:"0 24px"}} {...swipeBack}>
        <button onClick={onBack} style={{background:"none",border:"none",color:"#FF6B35",fontSize:14,cursor:"pointer",display:"flex",alignItems:"center",gap:4,padding:"20px 0 12px 0",fontFamily:"inherit"}}>← {t.back}</button>
...
function MeasurementsView({ folder, onUpdate, onBack, units, t }) {
  ...
  return (
    <div>
      <div style={{padding:"0 24px"}} {...swipeBack}>
        <button onClick={onBack} style={{background:"none",border:"none",color:"#00D4AA",fontSize:14,cursor:"pointer",display:"flex",alignItems:"center",gap:4,padding:"20px 0 12px 0",fontFamily:"inherit"}}>← {t.back}</button>
...
function SettingsScreen({ lang, units, onSwitchLang, onSetUnits, onClearData, onBack, t, nickname, onSetNickname }) {
  ...
  return (
    <div style={{padding:"0 16px", paddingBottom: 40}} {...swipeBack}>
      <button onClick={onBack} style={{background:"none",border:"none",color:"#FF6B35",fontSize:14,cursor:"pointer",display:"flex",alignItems:"center",gap:4,padding:"20px 8px 12px 0",fontFamily:"inherit"}}>← {t.back}</button>
